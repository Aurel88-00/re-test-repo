...
import { bgImage } from '@/lib/bg-image'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-gray-900/50 border-gray-700 shadow-xl rounded-xl transition-transform transform hover:scale-105 ">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-gray-900/50 border-gray-700 shadow-xl rounded-xl transition-transform transform hover:scale-105">
                <CardContent className="p-6">
